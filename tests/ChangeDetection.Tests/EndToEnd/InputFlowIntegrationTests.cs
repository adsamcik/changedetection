...
public class InputFlowIntegrationTests : TestBase
{
    ...
    public async Task InputAnchorValidator_ValidatesUrlInOriginalInput()
    {
        ...
        var result = validator.ValidateUrl(
            ...
            ["https://example.com/events I want to watch for events"]);
    ...
    public async Task InputAnchorValidator_ValidatesOptionSelection()
    {
        ...
        var options = new List<PresentedOption>
        {
            new("opt1", "Event cards", ".event-card"),
            new("opt2", "Event titles", ".event-title"),
            new("opt3", "Full page", "fullpage")
        };

        var result = validator.ValidateSelection("Event cards", options);

        result.IsValid.ShouldBeTrue();
        result.MatchedOption.ShouldNotBeNull();
    ...
    public async Task InputAnchorValidator_RejectsInvalidSelection()
    {
        ...
        var result = validator.ValidateSelection("Something not presented", options);
