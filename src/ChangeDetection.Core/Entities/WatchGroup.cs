...
public class WatchGroup : IOwnedEntity
{
    ...
    /// <summary>
    /// Domain-agnostic configuration for item tracking, display field mapping,
    /// hard-fail dimensions, and alert behavior. Generated by LLM at setup time.
    /// When null, defaults are used (job-listing domain for backward compatibility).
    /// </summary>
